...
public class TestConfig implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // ==== USERS ====
        User user1 = new User(null, "520.834.160-31", "Ana", "9999-9999", "Avenida General Carneiro, 1560", "Arquiteta",
                "ana@email.com", UserRole.ADMIN, "123");
        User user2 = new User(null, "268.647.710-59", "Fernando", "9888-9999", "Rua da Penha, 56", "Arquiteto",
                "fernando@email.com", UserRole.MEMBER, "456");
        User user3 = new User(null, "572.761.830-41", "Beatriz", "9777-9999", "Avenida Barão de Tatuí, 104",
                "Designer Gráfica", "beatriz@email.com", UserRole.CUSTOMER, "789");
